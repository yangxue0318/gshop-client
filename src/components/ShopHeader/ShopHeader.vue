<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowBullitin=true">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowBullitin">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isShowBullitin=false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover" @click="isShowBullitin=false"></div>
    </div>
    </transition>
